...
const upcomingGoals = [
  { label: "Complete 30 tests", current: 24, target: 30, color: "bg-violet-500" },
  { label: "Reach 85% avg score", current: 78, target: 85, color: "bg-blue-500" },
  { label: "Study 50 hours", current: 30, target: 50, color: "bg-emerald-500" },
];

const quickExams = [
  { name: "NISM Series XV", tag: "Finance", emoji: "📈" },
  { name: "AWS Solutions Architect", tag: "Cloud", emoji: "☁️" },
  { name: "Python Certification", tag: "Tech", emoji: "🐍" },
  { name: "SSC CGL", tag: "Govt", emoji: "🏛️" },
];

export default function DashboardPage() {
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <HeroCard userName="Ankit" />
                ...
                {quickExams.map((exam) => (
                  <Link key={exam.name} href="/tests">
                    <div className="flex items-center gap-3 p-2.5 rounded-xl hover:bg-accent transition-colors cursor-pointer group">
                      ...
                      <Badge variant="secondary" className="text-[10px] shrink-0">{exam.tag}</Badge>
          ...
          <CardContent className="flex items-center gap-4 p-5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-muted-foreground text-xs mt-0.5">
                Spaced repetition is 90% more effective than massed practice. Review your weak topics every 3 days for best retention.
              </p>
            </div>
